...
using RK_2_2 = ButcherTable<
    ...
    std::array<T, 2>{{ T(0.5), T(0.5) }},
    std::array<T, 2>{{ T(0),   T(1)   }}
>;

template <typename T>
using RK_3_3 = ButcherTable<
    T,
    3,
    T(1),
    ...
    std::array<T, 3>{{ T(1./6.), T(1./6.), T(2./3.) }},
    std::array<T, 3>{{ T(0),     T(1),     T(0.5)   }}
>;

template <typename T>
using RK_10_4 = ButcherTable<
    T,
    10,
    T(6),
    ...
    std::array<T, 10>{{T(0.1), T(0.1),    T(0.1),    T(0.1),    T(0.1),    T(0.1),    T(0.1),    T(0.1),    T(0.1),    T(0.1)}},
    std::array<T, 10>{{T(0),   T(1)/T(6), T(1)/T(3), T(1)/T(2), T(2)/T(3), T(1)/T(3), T(1)/T(2), T(2)/T(3), T(5)/T(6), T(1)  }}
>;
...
template <typename T>
struct RungeKutta<T, 1> { using type = RK_1_1<T>; };

template <typename T>
struct RungeKutta<T, 2> { using type = RK_2_2<T>; };

template <typename T>
struct RungeKutta<T, 3> { using type = RK_3_3<T>; };

template <typename T>
struct RungeKutta<T, 4> { using type = RK_10_4<T>; };
